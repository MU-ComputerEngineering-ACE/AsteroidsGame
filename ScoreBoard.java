...
public class ScoreBoard extends Actor
{
    ...
    private void drawScores()
    {
        ...
        drawString("All Players", getImage().getWidth() / 4 - 50, topSpace - HEADER_TEXT_HEIGHT - 5, MAIN_COLOR, HEADER_TEXT_HEIGHT);
        drawString("Near You", 3*getImage().getWidth() / 4 - 40, topSpace - HEADER_TEXT_HEIGHT - 5, MAIN_COLOR, HEADER_TEXT_HEIGHT);        
